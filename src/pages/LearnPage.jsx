                ...
                <>
                  ...
                  <div className="bg-gradient-to-br from-gold-100 via-rose-50 to-cream rounded-3xl p-6 shadow-soft">
                    ...
                    <h3 className="font-serif text-title text-forest text-center mb-4">
                      Explore {activeTab === 'urdu' ? 'Urdu' : activeTab === 'tagalog' ? 'Tagalog' : 'Arabic'}
                    </h3>
                    ...
                    <button 
                      ...
                      className="w-full py-4 bg-forest text-cream-100 rounded-2xl font-medium"
                    >
                      Start Exploring
                    </button>
                  </div>
          ...
          <div className="px-6 py-8">
            <div className="max-w-lg mx-auto">
              ...
              >
                ...
                <span className="text-body font-medium">Back to today's lesson</span>
              </button>

              <div className="text-center mb-8">
                <h2 className="font-serif text-display-sm text-forest mb-2">
                  {activeTab === 'urdu' ? 'Urdu' : activeTab === 'tagalog' ? 'Tagalog' : 'Arabic'} Library
                </h2>
              ...
              {!selectedCategory ? (
                <div className="space-y-4">
                  {/* Vibe Categories */}
                  {[
                    { id: 'love', label: 'Love & Endearment', desc: 'Sweet words for your Jaan', gradient: 'from-rose-100 to-rose-200' },
                    { id: 'food', label: 'Food & Dining', desc: 'Talk about delicious food', gradient: 'from-gold-100 to-gold-200' },
                    { id: 'family', label: 'Family & Respect', desc: 'Words for loved ones', gradient: 'from-forest-50 to-forest-100' },
                    { id: 'daily', label: 'Daily Essentials', desc: 'Common everyday phrases', gradient: 'from-cream-200 to-cream-300' },
                    { id: 'emotions', label: 'Feelings & Emotions', desc: 'Express how you feel', gradient: 'from-purple-100 to-purple-200' },
                    { id: 'culture', label: 'Culture & Customs', desc: 'Traditions & etiquette', gradient: 'from-blue-100 to-blue-200' },
